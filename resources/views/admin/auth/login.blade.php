@extends('layouts.admin.unauth_app')
@section('content')
                                ...
                                <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                    <div class="card-header pb-1">
                                        <div class="card-title">
                                            <h4 class="text-center mb-2">Welcome to the admin page</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(['method' => 'POST', 'route' => 'admin.login']) !!}
                                            <div class="form-group mb-50">
                                                {!! Form::label('email', 'Email address', ['class' => 'text-bold-600']) !!}
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('password', 'Password', ['class' => 'text-bold-600']) !!}
